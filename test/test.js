...
, function(e, t, n) {
        ...
        function(e, t, n) {
            ...
            value: function() {
                return pe.a.createElement("header", {
                    ...
                    className: "logo-mini"
                }, pe.a.createElement("b", null, "白月")), pe.a.createElement("span", {
                    className: "logo-lg"
                }, "白月", pe.a.createElement("b", null, "SMS"))), pe.a.createElement("nav", {
      ...
      , Ut = function(e) {
        ...
        function(e, t, n) {
            ...
            value: function() {
                ...
                }), pe.a.createElement("span", null, "药品"))), pe.a.createElement("li", null, pe.a.createElement(Mt, {
                    to: "/orders"
                }, pe.a.createElement("i", {
    ...
    var Qt = {
        ...
        fetchIpinfos: function() {
            var e = !(0 < arguments.length && void 0 !== arguments[0]) || arguments[0]
              , t = window.rStore.getState()
              , n = window.rStore.dispatch;
            e && null != t.ipinfos || Qt.ajax_get("/api/mgr/ipinfos", {
                action: "list_ipinfo"
            }, function(e) {
                n({
        ...
        function(e, t, n) {
            ...
            value: function() {
                ...
                return pe.a.createElement("div", null, pe.a.createElement(Yt, {
                    ...
                    width: "25%"
                }, "操作"))), pe.a.createElement("tbody", null, null == this.props.ipinfos ? null : this.props.ipinfos.map(function(t) {
                    return e.editing_id == t.id ? pe.a.createElement("tr", {
                        key: e.editing_data.id
                    }, pe.a.createElement("td", {
                        className: "textcenter"
      ...
      , en = ot(function(e) {
        ...
        return {
            ...
            onDelClick: function(e) {
                confirm("确定要删除此药品吗？") && Qt.ajax_delete("/api/mgr/ipinfos", {
                    action: "del_ipinfo",
                    id: e
                }, function() {
                    Qt.fetchIpinfos(!1)
      ...
      , tn = function(e) {
        ...
        function(e, t, n) {
            ...
            value: function() {
                ...
                return pe.a.createElement("div", null, pe.a.createElement("div", {
                ...
                })), pe.a.createElement("br", null), pe.a.createElement("br", null), "药品", pe.a.createElement("select", {
                    className: "xxx",
                    style: {
                        margin: "1em 2em",
                        border: "1px #3c763d solid"
                    ...
                    onChange: function(t) {
                        ...
                        try {
                            for (var i, l = e.add_data.ipinfos[Symbol.iterator](); !(o = (i = l.next()).done); o = !0)
                                if ((p = i.value).id === r)
                                    return
                        } catch (r) {
                            a = !0,
                        ...
                        var u, c = !0, s = !1;
                        try {
                            for (var f, p, d = e.props.ipinfos[Symbol.iterator](); !(c = (f = d.next()).done); c = !0)
                                (p = f.value).id === r && (e.add_data.ipinfos.push(p),
                                e.add_data.ipinfoids.push(r),
                                e.forceUpdate())
                        } catch (r) {
                            s = !0,
                            u = r
                    ...
                    key: "0",
                    value: "0"
                }, "-------"), this.props.ipinfos.map(function(e) {
                    return pe.a.createElement("option", {
                        key: e.id,
                        value: e.id
                    }, e.name)
                })), this.add_data.ipinfos.map(function(t) {
                    return pe.a.createElement("span", {
                        ...
                        onClick: function() {
                            var n = e.add_data.ipinfos.indexOf(t);
                            e.add_data.ipinfos.splice(n, 1),
                            e.forceUpdate()
                        }
                    }, t.name)
                })), pe.a.createElement("div", {
                    ...
                    width: "35%"
                }, "药品"))), pe.a.createElement("tbody", null, null == this.props.orders ? null : this.props.orders.map(function(t) {
                    return e.editing_id == t.id ? pe.a.createElement("tr", {
                        key: e.editing_data.id
                    }, pe.a.createElement("td", {
                        className: "textcenter"
                        ...
                        className: "textcenter"
                    }, pe.a.createElement("span", null, t.ipinfos_name)))
                }))))))))
            }
        }]),
        t
      ...
      , an = function(e) {
        ...
        function(e, t, n) {
            ...
            value: function() {
                ...
                }, "白月黑羽web教学使用"), pe.a.createElement("strong", null, "Copyright © 2016 ", pe.a.createElement("a", {
                    href: "#"
